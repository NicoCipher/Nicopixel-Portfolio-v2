-- ============================================
-- HOMEPAGE CONTENT MIGRATION (v2 — safe re-run)
...
DROP POLICY IF EXISTS "Public read why_items" ON why_items;
DROP POLICY IF EXISTS "Admin all why_items" ON why_items;
