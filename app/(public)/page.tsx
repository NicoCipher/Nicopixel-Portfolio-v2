  ...
  return (
    <>
      ...
      <style>{`
        ...
        .service-title { font-family: var(--font-heading); font-size: 24px; font-weight: 500; color: var(--fg); line-height: 1.2; }
        .service-desc { font-size: 14.5px; line-height: 1.8; color: var(--fg-muted); flex: 1; }
